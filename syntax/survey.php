<?php
/**
 * DokuWiki Plugin survey (Syntax Component)
 *
...
class syntax_plugin_survey_survey extends DokuWiki_Syntax_Plugin {
    ...
    public function connectTo($mode) {
        $this->Lexer->addEntryPattern('<survey>',$mode,'plugin_survey_survey');
    }
    ...
    public function render($mode, Doku_Renderer $renderer, $data) {
        ...
        if (count($data) > 0) {
            ...
            $renderer->doc .= '<div class="DokuwikiSurvey" id="survey_'
                              . $this->surveyNumber
                              . "\">\n";
            ...
            $renderer->doc .= '    var surveyConfig_'
                              . $this->surveyNumber
                              . ' = ' 
                              . json_encode($survey) 
                              . ";\n";
